...
options = {
"ok": "so that it fits with the previous conversation",
"odd": "so that if wont fit with the context of the previous conversation",
"off": "so that it is just a little bit off",
}
